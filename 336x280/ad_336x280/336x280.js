2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgqBRIAAieIAaAAIACAYQANgbAaAAQAJAAAJACQAAAOgDALQgJgCgKAAQgWAAgNAPIAAB5g");
	this.shape_15.setTransform(36.325,30.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("Ag1A9QgSgWgBgnQAAgmATgWQATgWAiAAQAjAAASAWQATAWAAAmQAAAngTAWQgTAWgiAAQghAAgUgWgAgrAAQAAA8ArAAQAsAAAAg8QAAg8gsAAQgrAAAAA8g");
	this.shape_16.setTransform(21.2,30.375);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgpBxIAAirQAAg2A3AAQAQAAAMADQAAAJgCAPQgNgEgLAAQgQAAgHAHQgGAIgBARIAAAMIA1AAIgDAXIgyAAIAACHg");
	this.shape_17.setTransform(8.6,27);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.mc_level4_jersey, new cjs.Rectangle(0,0,265.1,50.2), null);
...
(lib.mc_level1_finalJersey = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(296).call(this.frame_296).wait(7));

	// s
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EC0000").s().p("AhiCIQAAgWAHgWQAkAVAqAAQA9AAAAgoQAAgTgLgLQgKgJgZgJIgXgKQglgOgRgRQgWgXAAgiQAAgnAbgVQAbgWAxAAQAvAAAkANQgCAZgEARQgmgNgjABQg5gBAAAmQAAAfAwATIAXAKQAnAPARAQQATAVAAAfQAAAngcAYQgdAZg1AAQgzAAgkgUg");
	this.shape.setTransform(692.525,54.9);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(24).to({_off:false},0).to({_off:true},276).wait(3));

	// t
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#EC0000").s().p("AhEBpIAAklQAUgIAdAAIAABZIBYAAIgEArIhUAAIAACkQAAA1AsAAQAXAAAUgLIgGAsQgUALgcAAQhSAAAAhcg");
	this.shape_1.setTransform(671.85,50.775);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(23).to({_off:false},0).to({_off:true},277).wait(3));

	// n
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#EC0000").s().p("ABACYIAAi/QAAglgQgRQgQgRglAAQgbAAgfAIIAAD+IgyAAIAAkeQA7gRAyAAQB2AAAABpIAADGg");
	this.shape_2.setTransform(646.725,54.525);
	this.shape_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(22).to({_off:false},0).to({_off:true},278).wait(3));

	// u
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#EC0000").s().p("AhxAvIAAjHIAyAAIAADAQAAAlAQAQQAQARAmAAQAaAAAfgHIAAj/IAyAAIAAEeQg7ASgyAAQh2AAAAhpg");
	this.shape_3.setTransform(616.475,55.25);
	this.shape_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(21).to({_off:false},0).to({_off:true},279).wait(3));

	// o
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#EC0000").s().p("AhgByQghgpAAhJQgBhIAigpQAigqA+AAQA/AAAiAqQAiApAABIQgBBJghApQgjAqg+AAQg+AAgigqgAhOAAQAABxBOAAQBPAAAAhxQAAhwhPAAQhOAAAABwg");
	this.shape_4.setTransform(586.85,54.9);
	this.shape_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(20).to({_off:false},0).to({_off:true},280).wait(3));

	// c
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#EC0000").s().p("Ag+B1QgmgoAAhNQAAhJAigoQAjgqBEAAQAnAAAZAMQAAAUgFAVQgagKggAAQhWABAABwQAAA1AXAeQAYAdAoAAQAiAAAbgQQgBAYgFAVQgXAOglAAQg9AAgjgng");
	this.shape_5.setTransform(560.175,54.9);
	this.shape_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(19).to({_off:false},0).to({_off:true},281).wait(3));

	// c
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#EC0000").s().p("Ag+B1QgmgoAAhNQAAhJAigoQAjgqBEAAQAnAAAZAMQAAAUgFAVQgagKggAAQhWABAABwQAAA1AXAeQAYAdAoAAQAiAAAbgQQgBAYgFAVQgXAOglAAQg9AAgjgng");
	this.shape_6.setTransform(536.625,54.9);
	this.shape_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(18).to({_off:false},0).to({_off:true},282).wait(3));

	// a
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#EC0000").s().p("AhXB3QgfgoAAhOQAAicCKAAQA2AAAtAQIAAEgIguAAIgDgoQgaAvgxAAQg1AAgdglgAhCAAQAABxBJAAQAkAAAagcIAAi/QgYgHgaABQhVAAAABwg");
	this.shape_7.setTransform(509.075,54.9);
	this.shape_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_7).wait(17).to({_off:false},0).to({_off:true},283).wait(3));

	// s
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#EC0000").s().p("AhiCIQAAgWAHgWQAkAVAqAAQA9AAAAgoQAAgTgLgLQgKgJgZgJIgXgKQglgOgRgRQgWgXAAgiQAAgnAbgVQAbgWAxAAQAvAAAkANQgCAZgEARQgmgNgjABQg5gBAAAmQAAAfAwATIAXAKQAnAPARAQQATAVAAAfQAAAngcAYQgdAZg1AAQgzAAgkgUg");
	this.shape_8.setTransform(471.875,54.9);
	this.shape_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(16).to({_off:false},0).to({_off:true},284).wait(3));

	// g
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#EC0000").s().p("AhgDIQAAgVAEgXQAmATAnAAQBVAAAAhZIAAgoQgZAvgygBQg1AAgegmQgggoABhLQgBidCMAAQA3AAAtAPIAAEbQAACLiGAAQgtABglgUgAhEg+QAABvBNABQAkAAAZgdIAAi/QgWgGgcAAQhYAAAAByg");
	this.shape_9.setTransform(444.1,61.25);
	this.shape_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(15).to({_off:false},0).to({_off:true},285).wait(3));

	// n
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#EC0000").s().p("ABACYIAAi/QAAglgQgRQgQgRglAAQgbAAgfAIIAAD+IgyAAIAAkeQA7gRAyAAQB2AAAABpIAADGg");
	this.shape_10.setTransform(415.225,54.525);
	this.shape_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_10).wait(14).to({_off:false},0).to({_off:true},286).wait(3));

	// i
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#EC0000").s().p("AgYDWIAAkpIAxAAIAAEpgAgWibQgJgJAAgPQAAgPAJgJQAJgJANAAQAOAAAJAJQAJAJAAAPQAAAPgJAJQgJAJgOAAQgNABgJgKg");
	this.shape_11.setTransform(393.775,48.4);
	this.shape_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_11).wait(13).to({_off:false},0).to({_off:true},287).wait(3));

	// v
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#EC0000").s().p("AgYCVIhokpIA1AAIBMDwIBNjwIAzAAIhpEpg");
	this.shape_12.setTransform(374.825,54.875);
	this.shape_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_12).wait(12).to({_off:false},0).to({_off:true},288).wait(3));

	// a
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#EC0000").s().p("AhXB3QgfgoAAhOQAAicCKAAQA2AAAtAQIAAEgIguAAIgDgoQgaAvgxAAQg1AAgdglgAhCAAQAABxBJAAQAkAAAagcIAAi/QgYgHgaABQhVAAAABwg");
	this.shape_13.setTransform(346.375,54.9);
	this.shape_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_13).wait(11).to({_off:false},0).to({_off:true},289).wait(3));

	// s
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#EC0000").s().p("AhiCIQAAgWAHgWQAkAVAqAAQA9AAAAgoQAAgTgLgLQgKgJgZgJIgXgKQglgOgRgRQgWgXAAgiQAAgnAbgVQAbgWAxAAQAvAAAkANQgCAZgEARQgmgNgjABQg5gBAAAmQAAAfAwATIAXAKQAnAPARAQQATAVAAAfQAAAngcAYQgdAZg1AAQgzAAgkgUg");
	this.shape_14.setTransform(320.625,54.9);
	this.shape_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_14).wait(10).to({_off:false},0).to({_off:true},290).wait(3));

	// d
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#EC0000").s().p("AhYCxQgfgoAAhMQAAidCLAAQAbAAAXAEIAAhyQAWgIAdAAIAAGmIgvAAIgEgoQgYAvgyAAQg2AAgegmgAhEA8QAABwBMAAQAlAAAZgcIAAi/QgWgGgbAAQhZAAAABxg");
	this.shape_15.setTransform(279.25,48.775);
	this.shape_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_15).wait(9).to({_off:false},0).wait(294));

	// n
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#EC0000").s().p("ABACYIAAi/QAAglgQgRQgQgRglAAQgbAAgfAIIAAD+IgyAAIAAkeQA7gRAyAAQB2AAAABpIAADGg");
	this.shape_16.setTransform(250.475,54.325);
	this.shape_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(8).to({_off:false},0).wait(295));

	// a
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#EC0000").s().p("AhXB2QgfgnAAhOQAAicCKAAQA2AAAtAQIAAEgIguAAIgDgoQgaAvgxAAQg1AAgdgmgAhCAAQAABxBJAAQAkAAAagcIAAjAQgYgFgaAAQhVAAAABwg");
	this.shape_17.setTransform(219.675,54.7);
	this.shape_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_17).wait(7).to({_off:false},0).wait(296));

	// g
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#EC0000").s().p("AhgDIQAAgVAEgXQAmATAnAAQBVAAAAhaIAAgmQgYAtgzAAQg1AAgegmQgggoABhLQgBieCMAAQA3AAAtAQIAAEcQAACKiGAAQgtABglgUgAhEg9QAABuBMAAQAlAAAZgcIAAi+QgWgHgcAAQhYAAAABzg");
	this.shape_18.setTransform(177.35,61.5);
	this.shape_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_18).wait(6).to({_off:false},0).to({_off:true},294).wait(3));

	// n
	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#EC0000").s().p("ABACYIAAi/QAAglgQgRQgQgRglAAQgbAAgfAIIAAD+IgyAAIAAkeQA7gRAyAAQB2AAAABpIAADGg");
	this.shape_19.setTransform(148.475,54.775);
	this.shape_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_19).wait(5).to({_off:false},0).to({_off:true},295).wait(3));

	// i
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#EC0000").s().p("AgYDWIAAkpIAxAAIAAEpgAgWiaQgJgKAAgPQAAgPAJgKQAJgIANgBQAOABAJAIQAJAKAAAPQAAAPgJAJQgJAKgOAAQgNgBgJgIg");
	this.shape_20.setTransform(127.025,48.65);
	this.shape_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(4).to({_off:false},0).to({_off:true},296).wait(3));

	// k
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#EC0000").s().p("AA3DUIh0idIAAgEIBsiIIA7AAIhxCJIB8CggAh0DUIAAmeQAWgJAcABIAAGmg");
	this.shape_21.setTransform(109.2,48.85);
	this.shape_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_21).wait(3).to({_off:false},0).to({_off:true},297).wait(3));

	// n
	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#EC0000").s().p("ABACYIAAi/QAAglgQgRQgQgRglAAQgbAAgfAIIAAD+IgyAAIAAkeQA7gRAyAAQB2AAAABpIAADGg");
	this.shape_22.setTransform(79.025,54.775);
	this.shape_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_22).wait(2).to({_off:false},0).to({_off:true},298).wait(3));

	// a
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#EC0000").s().p("AhXB2QgfgnAAhOQAAicCKAAQA2AAAtAQIAAEgIguAAIgDgoQgaAvgxAAQg1AAgdgmgAhCAAQAABxBJAAQAkAAAagcIAAjAQgYgFgaAAQhVAAAABwg");
	this.shape_23.setTransform(48.225,55.15);
	this.shape_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_23).wait(1).to({_off:false},0).to({_off:true},299).wait(3));

	// B
	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#EC0000").s().p("AiCDUIAAmeQAugJA1AAQBJAAAmAeQAkAcAAA1QAABCg6AdQBJAYAABNQAAA4gkAeQgjAehBAAgAhOCmIBFAAQBYABAAhJQAAhIhaAAIhDAAgAhOiiIAACKIA/AAQBPAAAAhHQAAhGhcgBg");
	this.shape_24.setTransform(19.325,48.8);

	this.timeline.addTween(cjs.Tween.get(this.shape_24).to({_off:true},300).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-0.3,729.4,90.8);
...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	// primary_cta
	this.instance = new lib.primary_cta();
	this.instance.parent = this;
	this.instance.setTransform(168,235.1,0.8818,0.8819,0,0,0,72,17.1);
	this.instance.alpha = 0;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.primary_cta(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},30).wait(270));

	// logo_pos
	this.instance_1 = new lib.SantanderInternationalpos();
	this.instance_1.parent = this;
	this.instance_1.setTransform(311.25,88.25,0.554,0.5538,0,0,0,408.6,123.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300));

	// header_copy
	this.instance_2 = new lib.mc_level1_finalJersey();
	this.instance_2.parent = this;
	this.instance_2.setTransform(63.2,140.75,0.3927,0.3927,0,0,0,87.2,77.8);
	...
	this.instance_3.setTransform(67.25,168.35,0.5627,0.5628,0,0,0,68.7,43.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(94).to({_off:false},0).to({alpha:1},30).wait(176));

	// background_colour
	this.instance_4 = new lib.mc_background();
	this.instance_4.parent = this;
	this.instance_4.setTransform(168,140,1.12,0.4667,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:299.9,y:-140.95},29,cjs.Ease.quartInOut).wait(271));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(167,-140.9,170,421.9);
// library properties:
lib.properties = {
